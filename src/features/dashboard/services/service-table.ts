...
import { GetUsersParams, UsersResponse, ApiResponse, User, CreateUserRequest, UpdateUserRequest } from "../types/table-users";
...
class ApiClient {
  ...
  private async request<T>(
    ...
    // Si tienes token de autenticación, descomenta esto:
