...
import { User, GetUsersParams, CreateUserRequest, UpdateUserRequest, UserStatus } from '../types/table-users';
...
export const useUsers = (options: UseUsersOptions = {}): UseUsersState & UseUsersActions => {
  ...
  // Actualizar filtros
  const setFilters = useCallback((newFilters: Partial<GetUsersParams>) => {
